defmodule Ledger.Accounts.UserNotifier do
  ...
  def deliver_confirmation_instructions(user, url) do
    ...
    This link expires in 7 days. If you didn't create a Ledger account, you
    can safely ignore this email.
    """

    html =
      layout([
        paragraph("Welcome to Ledger! Confirm your email address to activate your account."),
        button("Confirm your account", url),
        muted(
          "This link expires in 7 days. If you didn't create a Ledger account, you can safely ignore this email."
        )
      ])

    deliver(user.email, "Confirm your Ledger account", text, html)
  end
  ...
  def deliver_reset_password_instructions(user, url) do
    ...
    html =
      layout([
        paragraph("You (or someone) requested a password reset for your Ledger account."),
    ...
    deliver(user.email, "Reset your Ledger password", text, html)
  end
              ...
              <table role="presentation" width="600" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="padding:24px 28px 0;font-family:#{@font};">
                    ...
                    <span style="color:#{@ink};font-weight:700;font-size:18px;vertical-align:middle;">Ledger</span>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding:18px 28px;border-top:1px solid #{@rule};color:#a1a1aa;font-size:12px;line-height:1.6;font-family:#{@font};">
                    #{if footer, do: footer <> "<br />", else: ""}Ledger — simple websites without the complexity.
                  </td>
                </tr>
              </table>
            </td>
