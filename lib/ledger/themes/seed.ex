defmodule Ledger.Themes.Seed do
  @moduledoc """
  ...
  stay on disk and are read on demand by `Ledger.Themes.Loader`.
  ...
  @doc false
  def discover do
    root = Path.join(:code.priv_dir(:ledger) |> to_string(), "themes")
