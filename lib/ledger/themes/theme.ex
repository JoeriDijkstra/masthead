defmodule Ledger.Themes.Theme do
  ...
  (for built-ins) or `themes/<slug>/<version>/` inside `Ledger.Storage`
  (for uploads). The renderer reads files through `Ledger.Themes.Loader`
  ...
  schema "themes" do
    ...
    has_many :sites, Ledger.Sites.Site
