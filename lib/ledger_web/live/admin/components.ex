defmodule LedgerWeb.AdminLive.Components do
  ...
  attr :active, :atom, default: nil, doc: ":overview | :posts | :pages | :uploads | :settings | :sites | :new_site"
  ...
  def shell(assigns) do
    ...
    <div class="admin-shell">
      ...
      <main class="admin-content">
        <div class="admin-flash" :if={@flash != %{} and Phoenix.Flash.get(@flash, :info)}>
          <p class="flash flash-info">{Phoenix.Flash.get(@flash, :info)}</p>
        </div>
        <div class="admin-flash" :if={@flash != %{} and Phoenix.Flash.get(@flash, :error)}>
  ...
  * `locked`   — when true, cards are non-interactive (no `phx-click`) and
  ...
  def format_cards(assigns) do
    ...
    <div class="format-cards">
      ...
      <button
        ...
        <h3>Blog</h3>
        <p>Renders the list of published posts. Body is shown as Markdown intro above the list. Set as homepage to make this the front page.</p>
  ...
  defp icon_home(assigns) do
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon">
      <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12 12 2.25 21.75 12M4.5 9.75v9.75A1.5 1.5 0 0 0 6 21h3.75v-6h4.5v6H18a1.5 1.5 0 0 0 1.5-1.5V9.75" />
    </svg>
    """
  end
  ...
  defp icon_doc(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon">
      <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487 18.549 2.8a2.121 2.121 0 1 1 3 3L19.862 7.487m-3-3L6.34 15.013a4.5 4.5 0 0 0-1.13 1.897l-.943 3.18 3.18-.943a4.5 4.5 0 0 0 1.897-1.13L19.862 7.487m-3-3 3 3" />
    </svg>
    """
  end
